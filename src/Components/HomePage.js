...
const HomePage = () => {
    return(
        <div class="display-container">
            <img className="w-full absolute brightness-50" src="https://ucarecdn.com/df5853e5-e339-451a-89bb-1c055c9c8095/"></img>
  ...
  <div class="container-fluid">
    ...
    <div>
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03" className="mr-20 mt-5">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 gap-2">
        ...
        <div className="image-content flex flex-col justify-center w-65 m-auto pt-20 relative font-serif font-semibold text-white text-center">
