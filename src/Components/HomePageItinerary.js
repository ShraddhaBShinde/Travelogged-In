            ...
            <div>
                <div className="flex flex-row ml-10">
                    ...
                    <div className="flex flex-col">
                        <div className="day-0 flex flex-row pl-10">
                        ...
                        <div className="day-1 flex flex-row pl-10 pt-20">
                            <div className="days-content flex flex-col space-x-7 mr-5">
                        ...
                        <div className="day-2 flex flex-row pl-10 pt-20">
                            <div className="days-content flex flex-col space-x-7 mr-5">
                        ...
                        <div className="day-3 flex flex-row pl-10 pt-20">
                            <div className="days-content flex flex-col space-x-7 mr-5">
                        ...
                        <div className="day-4 flex flex-row pl-10 pt-20">
